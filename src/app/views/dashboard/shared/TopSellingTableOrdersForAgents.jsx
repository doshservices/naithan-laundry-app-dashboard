...
import TopSellingTableOrdersForAgentsForSpecialOrders from './TopSellingTableOrdersForAgentsForSpecialOrders'
import CustomizedDialogAgentsSpecialOfferNew from 'app/views/material-kit/dialog/CustomizedDialogAgentSpecialOfferNew'
...
const TopSellingTableOrdersForAgents = ({ data, title, text, handleClick }) => {
    ...
    const handleSpecialModalOpen = (item) => {
        console.log('item', item)
        setOrderInfo(item)
    ...
    return (
        <Card elevation={3} className="pt-5 mb-6">
            ...
            <div className="overflow-auto">
                            ...
                            data.map((item, index) => (
                                <TableRow key={index} hover>
                                    ...
                                    <TableCell
                                        ...
                                        colSpan={1}
                                    >
                                        {item?.isSpecialOrder == 'YES' ? (
                                            <Button
                                                type="primary"
                                                onClick={() =>
                                                    handleSpecialModalOpen(item)
                                                }
                                                style={{
                                                    background: 'green',
                                                    color: 'white',
                ...
                {/* <TopSellingTableOrdersForAgentsForSpecialOrders /> */}
                {specialModal && (
                    <CustomizedDialogAgentsSpecialOfferNew data={orderInfo} handleModalClose={handleModalClose} />
                )}
            </div>
        </Card>
    )
...
export default TopSellingTableOrdersForAgents
