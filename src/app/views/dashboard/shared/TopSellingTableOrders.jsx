...
const TopSellingTableOrders = ({ data, title, text, handleClick }) => {
    ...
    return (
        <Card elevation={3} className="pt-5 mb-6">
            <div className="flex justify-between items-center px-12 mb-3">
                ...
                >
                    <TableHead>
                        <TableRow style={{background: "#EBECEE", color: "black"}}>
                            ...
                            <TableCell className="pl-12" colSpan={1}>
                                Special Order
                            </TableCell>
                            <TableCell className="px-0" colSpan={1}>
                                Action
...
export default TopSellingTableOrders
